 ...
 */
  ...
  #define THERMAL_PROTECTION_HYSTERESIS 8     // Degrees Celsius binx changed from 4
   ...
   * below 2.
   */
  #define WATCH_TEMP_PERIOD 30                // Seconds  binx changed from 20
 ...
 */
  ...
  #define THERMAL_PROTECTION_BED_HYSTERESIS     8 // Degrees Celsius binx changed from 2
