...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  29.46,  20.0 }
    #define DEFAULT_Ki_LIST {   4.27,   1.0 }
    #define DEFAULT_Kd_LIST { 50.83, 112.0 }
  #else
    #define DEFAULT_Kp  29.46
    #define DEFAULT_Ki   4.27
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 3200, 404 }  //404 esun white pla
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 550, 550, 5, 25 } //changed x and y from 400 to 550
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 39, 0, -1.9 }
...
#define X_BED_SIZE 310 //350 
#define Y_BED_SIZE 310 //400
